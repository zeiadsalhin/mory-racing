                ...
                <transition name="fade" mode="out-in">
                    <v-locale-provider :rtl="currentLocale == 'ar' ? true : false">
                        <v-parallax src="/mainicon.ico" placeholder="/mainicon.ico" cover
                            ...
                            <p class="md:ml-12 ml-5 py-3 lg:w-2/3 brightness-90 md:text-lg text-sm  mt-3 leading-snug ">
                                {{ $t('makemoneychattokdesc') }}:
                            </p>
                            <div
                                class="md:ml-[3.5rem] aml-5 py-3 space-y-5 lg:w-2/3 brightness-90 md:text-lg text-md mt-5 leading-snug ">
                                <ol class="space-y-5 text-md list-decimal p-3 md:ml-10 ml-3">
                                    <li>
